# genius_client.py — Análisis de letras con Genius + Claude AI
"""
...
LYRIC_THEMES = {
    "desamor":      ["ex", "olvidar", "perdiste", "extraño", "corazón roto", "llorar", "heartbreak",
    ...
    "motivacion":   ["poder", "fuerza", "arriba", "ganar", "éxito", "hustle", "grind", "rise",
...
class GeniusClient:
    ...
    def search_song(self, title: str, artist: str) -> Optional[Dict]:
        """Busca una canción en Genius y retorna el resultado más relevante."""
...
def analyze_seeds_with_genius(
    ...
    Retorna el perfil temático promedio.
    """
...
def score_candidate_by_themes(
    ...
    """
    Puntúa un candidato basándose en similitud temática de letras.
