...
"""
Last.fm da gratis:
- Tags de una canción (mood, género detallado, instrumentos, etc.)
- Canciones similares a una canción dada
- Tags de un artista
...
class LastFMClient:
    ...
    def get_track_tags(self, artist: str, track: str) -> List[str]:
        """Obtiene top tags de una canción."""
    ...
    def get_similar_tracks(self, artist: str, track: str, limit: int = 30) -> List[Dict[str, str]]:
        """Obtiene canciones similares según Last.fm."""
...
def get_lastfm_similar_ids(
    ...
    y devuelve {track_id -> score} de las que están en los Me Gusta.
    """
